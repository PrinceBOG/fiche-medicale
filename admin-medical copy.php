                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card p-0">
                                ...
                                <div class="card-body">
                                    <form action="rechUser.php" method="post">
                                            ...
                                            <div class="col-md-10">
                                                <div class="search-set">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="keywords" class="form-control" placeholder="Recherche" aria-label="Username" aria-describedby="basic-addon1">
...
<script>
    function highlightCards(keyword) {
        var cards = document.getElementsByClassName("card");
        for (var i = 0; i < cards.length; i++) {
            var card = cards[i];
            var name = card.querySelector('.name').textContent.toUpperCase(); // Assume que le nom est dans un élément avec la classe 'name'
